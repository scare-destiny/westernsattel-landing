			...
			<div class='px-4 py-16 mx-auto max-w-screen-2xl sm:px-6 lg:px-8'>
				<div class='items-end justify-between sm:flex'>
					<div class='max-w-xl'>
						...
						<p class='max-w-lg mt-8 text-500'>
				...
				<div class='mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3'>
					<blockquote class='flex flex-col justify-between h-full p-12 bg-white'>
						...
						<footer class='mt-8 text-gray-500'>Veronika L</footer>
					</blockquote>
					...
					<blockquote class='flex flex-col justify-between h-full p-12 bg-white'>
						...
						<footer class='mt-8 text-gray-500'>Petra Perle</footer>
					</blockquote>
					...
					<blockquote class='flex flex-col justify-between h-full p-12 bg-white'>
						...
						<footer class='mt-8 text-gray-500'>Julia K.</footer>
					</blockquote>
					...
					<blockquote class='flex flex-col justify-between h-full p-12 bg-white'>
						...
						<footer class='mt-8 text-gray-500'>Birgit Engler</footer>
					</blockquote>
				</div>
			</div>
		</section>
